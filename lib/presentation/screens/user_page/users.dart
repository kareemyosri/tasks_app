      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Text(
              'OnLongPress User Will Deleted',
              style: GoogleFonts.roboto(color: Colors.red),
            ),
            BlocBuilder<HomeCubit, HomeState>(
              builder: (context, state) {
                return Visibility(
                  visible: CashHelper.getString(key: MySharedKeys.userType) ==
                      'manager',
                                ...
                                EmployeeInfo(
                                  ...
                                  onLongPress: () {
                                    UserCubit.get(context).deleteUser(
                                        cubit.departmentEmployeesData[index].id!);
                                  },
                                ),
                              ],
                            );
            ...
            BlocBuilder<HomeCubit, HomeState>(
              builder: (context, state) {
                return Visibility(
                  visible:
                      CashHelper.getString(key: MySharedKeys.userType) == 'admin',
                  child: Expanded(
                ...
                children: [
                  BlocListener<UserCubit, UserState>(
                    ...
                    child: EmployeeInfo(
                      ...
                      onLongPress: () {
                        UserCubit.get(context).deleteUser(
                            departmentsAndEmployeesData.employees![index].id!);
                      },
                    ),
                  ),
                ],
